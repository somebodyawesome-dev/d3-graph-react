...
function PlayGround() {
  ...
  const [selectedExample, setSelectedExample] = useState("customGraph");
  ...
  const graphExamples = {
    customGraph: {
      nodes: [
        { id: "0", name: "Headquarters", type: "main", size: 140, color: "#ff9800" }, 
        { id: "1", name: "Human Resources", type: "department", size: 110, color: "#3b82f6" },
        { id: "2", name: "IT Department", type: "department", size: 110, color: "#9333ea" },
        { id: "3", name: "Marketing", type: "department", size: 110, color: "#ec4899" },
        { id: "4", name: "Finance", type: "department", size: 110, color: "#4caf50" },
        { id: "5", name: "Recruitment", type: "team", size: 90, color: "#60a5fa" },
        { id: "6", name: "Talent Management", type: "team", size: 90, color: "#60a5fa" },
        { id: "7", name: "Web Dev", type: "team", size: 90, color: "#a855f7" },
        { id: "8", name: "IT Support", type: "team", size: 90, color: "#a855f7" },
        { id: "9", name: "Advertising", type: "team", size: 90, color: "#f472b6" },
        { id: "10", name: "Public Relations", type: "team", size: 90, color: "#f472b6" },
        { id: "11", name: "Accounting", type: "team", size: 90, color: "#66bb6a" },
    ...
    iconGraph: {
      nodes: [
        ...
        { id: "15", type: "tape_storage", size: 70, icon: "💾", color: "#34495e" }, 
      ],
      links: [
        { source: "1", target: "0" },
        { source: "2", target: "0" },
    ...
    officeArchitecture: {
      nodes: [
        { id: "0", name: "CEO", type: "executive", size: 150, color: "#ff0000", icon: "👨‍💼" },
        { id: "1", name: "CTO", type: "executive", size: 130, color: "#1e90ff", icon: "👨‍💻" }, 
        { id: "2", name: "CFO", type: "executive", size: 130, color: "#4caf50", icon: "💰" }, 
        { id: "3", name: "COO", type: "executive", size: 130, color: "#f39c12", icon: "📊" }, 
        { id: "4", name: "Software Dev", type: "department", size: 110, color: "#9c27b0", icon: "💻" },
        { id: "5", name: "Infrastructure", type: "department", size: 110, color: "#8e44ad", icon: "🖥️" },
        { id: "6", name: "Accounting", type: "department", size: 110, color: "#27ae60", icon: "📑" },
        { id: "7", name: "Payroll", type: "department", size: 110, color: "#16a085", icon: "💵" },
        { id: "8", name: "HR Department", type: "department", size: 110, color: "#e67e22", icon: "👥" },
        { id: "9", name: "Customer Support", type: "department", size: 110, color: "#f1c40f", icon: "🎧" },
        { id: "10", name: "Frontend Team", type: "team", size: 90, color: "#e74c3c", icon: "🌐" },
        { id: "11", name: "Backend Team", type: "team", size: 90, color: "#3498db", icon: "🖥️" },
        { id: "12", name: "Tech Support", type: "team", size: 90, color: "#f1c40f", icon: "🛠️" },
      ],
      links: [
        { source: "0", target: "1" }, 
        { source: "0", target: "2" }, 
  ...
  const graphData = React.useMemo(() => {
    ...
    return {
      ...
      links: selectedGraph.links
        .filter((link) => nodeIds.has(Number(link.source)) && nodeIds.has(Number(link.target)))
        .map((link) => ({
...
<div className="mt-4 border-t pt-2">
  ...
  NodeComponent={({ node }: { node: GraphNode }) => {
    if (!node || !node.type) {
      return null; 
    }
    ...
    return (
      <div
        ...
        style={{
          ...
          width: isRectangle ? (node.size || 80) * 1.5 : isOval ? (node.size || 80) * 1.3 : node.size || 80, 
          height: node.size || 80,
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          border: "2px solid white",
          borderRadius: isRectangle ? "10px" : isOval ? "50% / 30%" : isSquare ? "15%" : "50%", 
          fontSize: "2rem", 
          padding: "10px",
        }}
      >
