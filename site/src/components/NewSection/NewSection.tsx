...
import { Container, Typography, List, ListItem, ListItemIcon, ListItemText, Hidden } from '@mui/material';
  ...
  return (
    <SectionContainer>
      ...
      <Container maxWidth="md">
        <ContentContainer>
          <FloatingChart src="/img/mars.png" alt="Floating Chart 1" style={{ top: '1%', left: '-2%', opacity: '0.6', zIndex: -1 }} />
          <FloatingChart src="/img/astro1.png" alt="Floating Chart 1" style={{ bottom: '10%', left: '8%', opacity: '0.7', zIndex: -1 }} />
          <FloatingChart src="/img/mercury.png" alt="Floating Chart 1" style={{ bottom: '5%', right: '-5%', width: '200px', height: 'auto', opacity: '0.7', zIndex: -1 }} />
          ...
          <Hidden mdDown>
            <ImageContainer>
              <img
                src="/img/D3_JS_Projects.png" // Replace with your image URL
